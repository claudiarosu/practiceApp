# Bucharest School Search: Feature Backlog

This backlog tracks the automated development of the application. The "Architect's Pulse" workflow implements one feature every morning at 9:00 AM.
...
6.  **Proximity Search**: Add a "Near Metro" toggle and distance-based sorting for schools.
...
- [x] Prisma Schema for Bucharest Schools (Phase 1)
- [x] Initial School Listing UI with Mock Data (Phase 2 Foundation)
- [x] Development Workflow Skills (Architect, Engineer, Reviewer, Tester)
